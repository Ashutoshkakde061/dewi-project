                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('edit-store-counters', $data->counter_id) }}" method="POST" enctype="multipart/form-data">
...
<div class="mb-3">
    ...
    <input type="number" class="form-control" id="count" name="count" value="{{ old('count', $data->count) }}" />
    @error('count')
    <div class="text-danger">{{ $message }}</div>
    @enderror
</div>
