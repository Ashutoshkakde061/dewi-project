              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{ route('add-store-services') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label class="form-label" for="img-default-company">Image</label>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="integer" class="form-control" id="description" name="description"  />
                          @error('description')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>
