              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body ">
                        <form action="{{route('edit-storenewcourse', $data->newcourse_id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- Course Name -->
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-5 col-6 col-lg-4">
                                                <input name="days[]" id="days" placeholder="Enter Days"
                                                    class="form-control" type="number" min="1" value="{{ old('days.0') }}">
                                                @error('days.*')
